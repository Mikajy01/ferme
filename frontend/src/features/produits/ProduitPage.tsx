...
import type { ProductsFilters } from '../../services/productService';
        ...
        {showAddProduct && (
          <div className="fixed inset-0 bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg max-w-md w-full p-6 shadow-2xl">
              <h2 className="text-2xl mb-6 text-[var(--color-text)] font-bold">Nouveau Produit</h2>
              
              <div className="space-y-4">
                <div>
                  <label className="block mb-2 text-[var(--color-text)]">Nom du produit</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block mb-2 text-[var(--color-text)]">SKU</label>
                  <input
                    type="text"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                ...
                <div>
                  <label className="block mb-2 text-[var(--color-text)]">Catégorie</label>
                  <select
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                ...
                <div>
                  <label className="block mb-2 text-[var(--color-text)]">Unité</label>
                  <select
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-4 h-4"
                  />
                  <label htmlFor="isSellable" className="text-[var(--color-text)]">Produit vendable</label>
                </div>
              </div>
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-[var(--color-primary)] text-white rounded-lg disabled:opacity-50"
                  disabled={creating}
                >
        ...
        {showAddUnit && (
          <div className="fixed inset-0 bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg max-w-sm w-full p-6 shadow-2xl">
              <h2 className="text-2xl mb-6 text-[var(--color-text)] font-bold">Nouvelle Unité</h2>
              
              <div className="space-y-4">
                <div>
                  <label className="block mb-2 text-[var(--color-text)]">Code de l'unité</label>
                  <input
                    type="text"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                    value={newUnit.code}
                ...
                <div>
                  <label className="block mb-2 text-[var(--color-text)]">Nom de l'unité</label>
                  <input
                    type="text"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                    value={newUnit.name}
